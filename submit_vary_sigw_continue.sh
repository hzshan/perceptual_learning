BATCH_NAME='3L_MSE_GD_sigw_sigs0p2_lambdaP015_cont'
CP_NAME='3L_MSE_GD_sigw_sigs0p2_lambdaP015_'
...
SCRIPT_NAME='main_no_converge_continue.py'
# SCRIPT_NAME='main.py'

SBATCH_NAME='main_fas_continue.sbatch' # main.sbatch // main_own_partition.sbatch // main_fas.sbatch
FOLDER_NAME='PL'
ENV_NAME='continual'
...
TIME_REQUESTED=0-12:00  # format: D-HH:MMhahahah
...
export SCRIPT_NAME BATCH_NAME SBATCH_NAME FOLDER_NAME ENV_NAME nonlinearity eta n_train_trials loss test_interval noise_var lambda2 n_learn CP_NAME
